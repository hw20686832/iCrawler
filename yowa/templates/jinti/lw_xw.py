...
class Parser(Base):
    ...
    def extract(self):
        ...
        content_node = doc('div.innerbody')
        content_node.remove('script')
        content_node.remove('div.gray')
        content_node.remove('div#ckepop')
        content_node.remove('form')
        content_node.remove('div[align="left"]')
        content_node.remove('div[align="right"]')
        ...
        item['title'] = self.title = doc('div.title')('h1').text()
