...
class Parser(Base):
    ...
    def extract(self):
        ...
        content_node = doc('div.articleBox')
        ...
        item = ContentItem()
        imgs = content_node('.articleCont')('img')
        img_all = []
        for img in imgs:
        ...
        item['content'] = self.content = content_node('.articleCont').__unicode__()    
        
        release_time=content_node('.articleInfo').text()
