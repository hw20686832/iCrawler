...
class Parser(Base):
    ...
    def extract(self):
        ...
        content_node = doc('#art')
        content_node.remove('.fenx')
        content_node.remove('.guan')
        content_node.remove('.pren')
        
        item = ContentItem()
        imgs = content_node('.wenz')('img')
        img_all = []
        for img in imgs:
        ...
        item['content'] = self.content = content_node('.wenz').__unicode__()    
        
        release_time=content_node('.info').text()
