...
class Parser(Base):
    ...
    def extract(self):
        ...
        content_node = doc('div.details.fontsize14.textjust').remove('script')
        ...
        item['title'] = self.title = doc('div.details.fontsize14.textjust').find('strong').text()
        ...
        item['release_time'] = self.release_time = doc('#askTime').text()
