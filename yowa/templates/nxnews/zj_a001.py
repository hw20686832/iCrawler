...
class Parser(Base):
    ...
    def extract(self):
        ...
        content_node = doc('table[width = "100%"][cellspacing = "8"][cellpadding = "0"]')
        ...
        item['title'] = self.title = doc('span[class = "listblackfont20h30heiti"]').text()
            
        item['content'] = self.content = content
        
        self.release_time = doc('td[class = "Navsl"]').text()
